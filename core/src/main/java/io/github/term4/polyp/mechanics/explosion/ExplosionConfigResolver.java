...
public final class ExplosionConfigResolver {
    ...
    public static ResolvedExplosionConfig resolve(@Nullable ExplosionConfig config, ExplosionContext ctx) {
        ...
        return new ResolvedExplosionConfig(
                ...
                FieldValue.resolve(cfg != null ? cfg.damageModel : null, ctx, ExplosionConfig.DamageModel.CURVE),
                FieldValue.resolve(cfg != null ? cfg.flatDamage : null, ctx, 0.0),
    ...
    public record ResolvedExplosionConfig(
            ...
            boolean floorDamage,
            ExplosionConfig.DamageModel damageModel,
            double flatDamage,
